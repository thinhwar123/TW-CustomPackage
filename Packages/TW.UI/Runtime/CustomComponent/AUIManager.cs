...
public class AUIManager : Singleton<AUIManager>
{
    ...
    private Dictionary<System.Type, AUIPanel> AUIPanels { get; set; } = new Dictionary<System.Type, AUIPanel>();
    private Dictionary<System.Type, AUIPanel> AUIPanelsPrefab { get; set; } = new Dictionary<System.Type, AUIPanel>();
    ...
    {
        return AUIPanels.ContainsKey(typeof(T)) && AUIPanels[typeof(T)] != null && AUIPanels[typeof(T)].gameObject.activeInHierarchy;
    }
