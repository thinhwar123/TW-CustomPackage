...
namespace TW.UI.CustomComponent
{
    ...
    public class AUIPanel : AwaitableCachedMonoBehaviour
    {
        ...
        protected virtual void Init()
        {
            ...
            OnCompletedOpenPanel.AddListener(() => { SetInteractable(true); });
            OnStartClosePanel.AddListener(() => { SetInteractable(false); });
        ...
        public virtual T OpenPanel<T>() where T : AUIPanel
        {
            ...
            AnimWaiter?.Kill();
            AnimWaiter = new AWaiter().OnComplete(() => { OnCompletedOpenPanel?.Invoke(); })
        ...
        public virtual T ClosePanel<T>() where T : AUIPanel
        {
            ...
            AnimWaiter?.Kill();
            AnimWaiter = new AWaiter().OnComplete(() => { OnCompletedClosePanel?.Invoke(); })
