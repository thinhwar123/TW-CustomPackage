...
namespace TW.Utility.DesignPattern
{
    ...
    public class UniTaskStateMachine<T> : IStateMachineDebug where T : class
    {
        ...
        public void RequestTransition(UniTaskState<T> uniTaskState, UnityAction beforeTransitionCallback = null, UnityAction afterTransitionCallback = null)
        {
        ...
        public bool IsCurrentState(UniTaskState<T> uniTaskState)
        {
            return m_CurrentUniTaskState == uniTaskState;
        }
